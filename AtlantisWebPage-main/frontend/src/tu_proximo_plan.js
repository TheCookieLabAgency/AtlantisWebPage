        ...
        <div className="plan-page tu-plan-page">
            ...
            <header className="main-header-fon-tuPlan">
                <div className="banner-title">
                    <p className="hero-kicker">Tu pr&oacute;ximo plan</p>
                    <h1>Planes que prenden la chispa</h1>
                    <p className="hero-sub">Elige un plan, comp&aacute;rtelo con tu comunidad y deja que Atlantis se encargue del resto.</p>
            ...
            <section className="find-section">
                <div className="find-headline">
                    ...
                    <p className="find-copy">Desde viajes de cuento hasta sabores y deporte, comparte las novedades con tus clientes y activa la participaci&oacute;n.</p>
                </div>
                ...
                <div className="events-grid">
                    ...
                    <div className="event-card">
                        <Link to="/Blog3" className="event-link">
                            ...
                            <img src={beautyLoversImg} alt="Beauty and Sport Lovers" />
                            <div className="event-overlay">
